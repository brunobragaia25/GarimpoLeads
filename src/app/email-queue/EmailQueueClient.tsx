...
import { CheckCircle2, Copy, Loader2, Mail, SkipForward, ExternalLink, Globe, Trash2 } from "lucide-react";
...
export function EmailQueueClient({ leads }: { leads: EmailQueueLead[] }) {
  ...
  return (
    <div className="mt-6">
      <p className="text-sm text-zinc-500 dark:text-zinc-400">
        {remaining} restante(s) na fila &middot; {doneCount} marcado(s) nessa sessão
      </p>
      ...
      <div className="mt-3 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          ...
          >
            ...
            {loading ? "Marcando..." : "Enviei, próximo"}
          </button>
